...
<div id="wrapper">
	...
	<div class="main-content">
		<div class="row small-spacing">
			<div class="col-xs-12">
			<h1 class="page-title" style="color:blue;">ADD FACULTY </h1>
				...
				<div class="form-group">
							...
							<div class="row">
								...
								<input type="text" maxlength="50" class="form-control" name="username" placeholder="Enter Username" required>
							</div>
								...
								<input type="text" maxlength="30" class="form-control" name="full_name" id="inputTwitter" placeholder="Enter Full Name" required>
							</div>
						...
						<div class="row">
								...
								<input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" maxlength="155" class="form-control" name="email" id="inputTwitter" placeholder="xyx@xyz.com" required>
							</div>
	...
	<option value="ZW">+263</option>
								...
								<input type="text" data-minlength="10" maxlength="10" class="form-control" name="mobile_no"  placeholder="Enter Mobile Number "  required>
               ...
               ?>
					                 	<option value="<?php echo $row['subject_name'];?>"><?php echo $row['subject_name'];?>   (<?php echo $row['subject_code'];?>)</option>
						...
						<div class="form-group">
							...
							<div class="row">
								<div class="form-group col-sm-6">
									<input type="text" data-minlength="6" class="form-control" name="password" id='p' placeholder="Password" required>
