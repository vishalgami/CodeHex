...
<div id="wrapper">
	...
	<div class="main-content">
		<div class="row small-spacing">
			<div class="col-xs-12">
			<h1 class="page-title" style="color:blue;">EDIT SEMESTER </h1>
				<div class="box-content">
				   <ul class="list-inline">
				      ...
				      <form data-toggle="validator" action="update_semester.php" method="post">
					  
					  <?php
					 $id=$_GET['id'];
				$result = $db->prepare("SELECT * FROM semester WHERE semester_id= :post_id");
               ...
               ?>
			   <input type="hidden" name="id" value="<?php echo $row['semester_id'];?>" required>
							...
							<div class="row">
								...
								<input type="text" maxlength="50" class="form-control" name="semester"  value="<?php echo $row['semester_name'];?>" required>
							</div>
