...
<div id="wrapper">
	...
	<div class="main-content">
		<div class="row small-spacing">
			<div class="col-xs-12">
			<h1 class="page-title" style="color:blue;">ADD SUBJECT </h1>
				...
				<ul class="list-inline">
				      ...
				      <form data-toggle="validator" action="process_add_subject.php" method="post">
							...
							<div class="row">
								...
								<input type="text" maxlength="250" class="form-control" name="subject"  placeholder=" Enter Subject Name" required>
							</div>
							...
							<div class="row">
								...
								<label for="inputPassword" class="control-label">Subject Code</label>
									...
									<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-user frm-ico"></i></span>
								<input type="text" maxlength="250" class="form-control" name="subject_code"  placeholder=" Enter Subject Name" required>
							</div>
