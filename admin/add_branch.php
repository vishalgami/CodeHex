...
<div id="wrapper">
	...
	<div class="main-content">
		<div class="row small-spacing">
			<div class="col-xs-12">
			<h1 class="page-title" style="color:blue;">ADD BRANCH </h1>
				<div class="box-content">
					<h4 class="box-title"><a href="view_branch.php" class="btn btn-success btn-xs waves-effect waves-light" >VIEW ALL BRANCH</a> </h4>
				      <form data-toggle="validator" action="process_add_branch.php" method="post">
							...
							<div class="row">
								...
								<input type="text" maxlength="50" class="form-control" name="branch"  placeholder=" Enter Branch Name" required>
							</div>
