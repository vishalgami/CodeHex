				...
				<div class="box-content">
					...
					<div class="form-group">
							...
							<div class="row">
								...
								<label for="inputPassword" class="control-label">Username</label>
								
									<input type="text"  class="form-control" id="ig-1" name="username" value="<?php echo $row['username'];?>" required>
