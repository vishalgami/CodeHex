...
<div id="wrapper">
	...
	<div class="main-content">
		<div class="row small-spacing">
			<div class="col-xs-12">
			<h1 class="page-title" style="color:blue;">EDIT SUBJECT </h1>
				<div class="box-content">
				   <ul class="list-inline">
						...
						<li class="margin-bottom-10"> <a  href="view_subject.php"><button type="button" class="btn btn-success btn-xs waves-effect waves-light">VIEW ALL SUBJECT</button></a></li>

				    
					</ul>
					
				      <form data-toggle="validator" action="update_subject.php" method="post">
					  
					  <?php
					 $id=$_GET['id'];
				$result = $db->prepare("SELECT * FROM subject WHERE subject_id= :post_id");
			   ...
			   <input type="hidden" name="id" value="<?php echo $row['subject_id'];?>" required>
							...
							<div class="row">
								...
								<input type="text" maxlength="50" class="form-control" name="subject"  value="<?php echo $row['subject_name'];?>" required>
							</div>
							...
							<div class="row">
								<div class="form-group col-sm-6">
								<label for="inputPassword" class="control-label">Subject Code</label>
								
									<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-user frm-ico"></i></span>
								<input type="text" maxlength="50" class="form-control" name="subject_code"  value="<?php echo $row['subject_code'];?>" required>
							</div>
