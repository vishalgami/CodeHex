...
<div id="wrapper">
	...
	<div class="main-content">
		<div class="row small-spacing">
			<div class="col-xs-12">
			<h1 class="page-title" style="color:blue;">ADD CHAPTER </h1>
				<div class="box-content">
					<ul class="list-inline">
				      ...
				      <form data-toggle="validator" action="process_add_chapter.php" method="post">
							...
							<div class="row">
								...
								<input type="text" maxlength="500" class="form-control" name="chapter"  placeholder=" Enter Chapter Name" required>
							</div>
