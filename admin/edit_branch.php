...
<div id="wrapper">
	...
	<div class="main-content">
		<div class="row small-spacing">
			<div class="col-xs-12">
			<h1 class="page-title" style="color:blue;">EDIT BRANCH </h1>
				<div class="box-content">
				   <ul class="list-inline">
						...
						<li class="margin-bottom-10"> <a  href="view_branch.php"><button type="button" class="btn btn-success btn-xs waves-effect waves-light">VIEW ALL BRANCH</button></a></li>

				    
					</ul>
					
				      <form data-toggle="validator" action="update_branch.php" method="post">
					  
					  <?php
					 $id=$_GET['id'];
				$result = $db->prepare("SELECT * FROM branch WHERE branch_id= :post_id");
               ...
               ?>
			   <input type="hidden" name="id" value="<?php echo $row['branch_id'];?>" required>
							...
							<div class="row">
								...
								<input type="text" maxlength="50" class="form-control" name="branch"  value="<?php echo $row['branch_name'];?>" required>
							</div>
