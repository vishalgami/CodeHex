	...
	<div class="main-content">
		<div class="row small-spacing">
			...
			<div class="col-sm-6">
				...
				<?php
                          $m= $_SESSION['SESS_USER_ID'];
				$result = $db->prepare("SELECT count(*) as total FROM question WHERE faculty_id = '$m'");
				$result->execute();
               ...
               ?>
					...
					<h4 class="box-title text-success">Total Question</h4>
					<!-- /.box-title -->
			...
			<div class="col-sm-6">
				<div class="box-content">
					<h4 class="box-title text-orange">Question Generated Activity</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
					...
					<div class="content widget-stat">
						...
						<div class="right-content">
							...
							<!-- /.counter -->
							<p class="text text-orange">Students</p>
							<!-- /.text -->
						</div>
						<!-- .right-content -->
					</div>
		...
		<div class="row small-spacing">
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Student Activity Of Months</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Student Activity</h4>
					<!-- /.box-title -->
					<div class="dropdown js__drop_down">
						<a href="#" class="dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button"></a>
						<ul class="sub-menu">
