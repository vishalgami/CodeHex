...
<link rel="icon" type="image/png" href="admin/assets/images/logo.png"/>
    ...
    <div class="header-outs" id="header">
      <div class="header-w3layouts">
            ...
            <div class="col-lg-6 col-md-7 col-sm-9 info-contact-agile">
              <ul>
                ...
                <li>
                  ...
                  <p><a href="mailto:info@example.com">Codehex@gamil.com</a></p>
                </li>
                <li>
                </li>
              </ul>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="hedder-up">
            <h1 ><a href="index.html" class="navbar-brand" data-blast="color">Marwadi University</a></h1>
          </div>
      ...
      <div class="container-fluid ">
        <div class="main row ">
          ...
          <div class="col-lg-4 view view-tenth">
            ...
            <div class="mask">
              <h3 data-blast="bgColor">Team Work</h3>
              <p>Vivamus sed poritor felis.ntesque habitant morbi senectus et netus</p>
              <a href="#" class="info" data-toggle="modal" data-target="#exampleModalLive" data-blast="bgColor">Read More</a>
            </div>
          </div>
      ...
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <div id="horizontalTab">
          <ul class="resp-tabs-list justify-content-center">
            <li data-blast="bgColor">Aim</li>
            <li data-blast="bgColor">Hard Work</li>
            <li data-blast="bgColor">Team Work</li>
            <li data-blast="bgColor">Success</li>
          </ul>
  ...
  <!--  <section class="blog py-lg-4 py-md-3 py-sm-3 py-3" id="blog">
    ...
    <section class="stats py-lg-4 py-md-3 py-sm-3 py-3" id="stats">
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        <h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Our Goal For Project</h3>
    ...
    <section class="team py-lg-4 py-md-3 py-sm-3 py-3" id="team">
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Meet With Team Member </h3>
        <div class="row ">
          <div class="col-lg-3 col-md-6 col-sm-6 profile">
            <div class="team-shadow">
              ...
              <div class="team-w3layouts-info py-lg-4 py-3 text-center" data-blast="bgColor">
                <h4 class="text-white mb-2">Vishal Gami</h4>
                <span class="wls-client-title text-black">TEAM MANAGER</span>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6 profile">
            <div class="team-shadow">
              ...
              <div class="team-w3layouts-info py-lg-4 py-3 text-center" data-blast="bgColor">
                <h4 class="text-white mb-2">Krutarth Belani</h4>
                <span class="wls-client-title text-black">DATABASE</span>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6 profile">
            <div class="team-shadow">
              ...
              <div class="team-w3layouts-info py-lg-4 py-3 text-center" data-blast="bgColor">
                <h4 class="text-white mb-2">Parthrajsinh jadeja</h4>
                <span class="wls-client-title text-black">UI DESIDNER</span>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6 profile">
            <div class="team-shadow">
              ...
              <div class="team-w3layouts-info py-lg-4 py-3 text-center" data-blast="bgColor">
                <h4 class="text-white mb-2">Chetan Khunti</h4>
          ...
          <div class="col-md-5 address-grid">
            <div class="addres-office-hour text-center" >
              ...
              <ul>
                ...
                <li class="mt-2">
                  <p><a href="mailto:info@example.com">Codehexteam@gmail.com</a></p>
                </li>
              </ul>
            </div>
          </div>
    ...
    <footer class="py-3">
      <div class="container">
        <div class="copy-agile-right text-center">
          ...
          <p> 
            © 2019 Major Project. All Rights Reserved | Design by <a href="#">Codehex Team</a>
          </p>
        </div>
      </div>
    </footer>
